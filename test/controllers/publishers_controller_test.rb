...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { name: @publisher.name, url: @publisher.url } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { name: @publisher.name, url: @publisher.url } }
